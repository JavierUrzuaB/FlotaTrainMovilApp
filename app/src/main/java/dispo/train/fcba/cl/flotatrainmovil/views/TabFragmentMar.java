...
public class TabFragmentMar extends Fragment implements HelperInterface {
    ...
    private String tab,tipo,fecha;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tab_fragment_mar, container, false);
        viewPivot= (RecyclerView)view.findViewById(R.id.vewPivote);
        btnCancelar = (Button) view.findViewById(R.id.btnCancelar2);
        rvDispoPivot= (RecyclerView)view.findViewById(R.id.rvDispoPivote);
        ...
        callListDispoNivel1(fecha,tipo,"OTRO");
