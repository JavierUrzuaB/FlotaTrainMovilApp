 ...
 */
public class flotaAPI {

    public static final String ENDPOINT_URL = "http://sistemas.fcab.cl/FlotaTrain/index.php/querys/Maestros/Flota/Flota/";
    ...
    private static flotaAPI instance;
    ...
    public static flotaAPI get() {
        if (instance == null) {
            instance = new flotaAPI();
        }
        return instance;
    }
